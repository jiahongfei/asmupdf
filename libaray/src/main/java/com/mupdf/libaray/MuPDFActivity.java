...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport {
    ...
    private void makeButtonsView() {
        int layoutButtons = getResources().getIdentifier("buttons", "layout", getPackageName());
//		mButtonsView = getLayoutInflater().inflate(R.layout.buttons,null);
        mButtonsView = getLayoutInflater().inflate(layoutButtons, null);

        int docNameText = getResources().getIdentifier("docNameText", "id", getPackageName());
        mFilenameView = (TextView) mButtonsView.findViewById(docNameText);

        int pageSlider = getResources().getIdentifier("pageSlider", "id", getPackageName());
        mPageSlider = (SeekBar) mButtonsView.findViewById(pageSlider);

        int pageNumber = getResources().getIdentifier("pageNumber", "id", getPackageName());
        mPageNumberView = (TextView) mButtonsView.findViewById(pageNumber);

        int info = getResources().getIdentifier("info", "id", getPackageName());
        mInfoView = (TextView) mButtonsView.findViewById(info);

        int searchButton = getResources().getIdentifier("searchButton", "id", getPackageName());
        mSearchButton = (ImageButton) mButtonsView.findViewById(searchButton);

        int reflowButton = getResources().getIdentifier("reflowButton", "id", getPackageName());
        mReflowButton = (ImageButton) mButtonsView.findViewById(reflowButton);

        int outlineButton = getResources().getIdentifier("outlineButton", "id", getPackageName());
        mOutlineButton = (ImageButton) mButtonsView.findViewById(outlineButton);

        int editAnnotButton = getResources().getIdentifier("editAnnotButton", "id", getPackageName());
        mAnnotButton = (ImageButton) mButtonsView.findViewById(editAnnotButton);

        int annotType = getResources().getIdentifier("annotType", "id", getPackageName());
        mAnnotTypeText = (TextView) mButtonsView.findViewById(annotType);

        int switcher = getResources().getIdentifier("switcher", "id", getPackageName());
        mTopBarSwitcher = (ViewAnimator) mButtonsView.findViewById(switcher);
//		mTopBarSwitcher = (ViewAnimator)mButtonsView.findViewById(R.id.switcher);

        int searchBack = getResources().getIdentifier("searchBack", "id", getPackageName());
        mSearchBack = (ImageButton) mButtonsView.findViewById(searchBack);

        int searchForward = getResources().getIdentifier("searchForward", "id", getPackageName());
        mSearchFwd = (ImageButton) mButtonsView.findViewById(searchForward);

        int searchText = getResources().getIdentifier("searchText", "id", getPackageName());
        mSearchText = (EditText) mButtonsView.findViewById(searchText);

        int linkButton = getResources().getIdentifier("linkButton", "id", getPackageName());
        mLinkButton = (ImageButton) mButtonsView.findViewById(linkButton);

        int moreButton = getResources().getIdentifier("moreButton", "id", getPackageName());
        mMoreButton = (ImageButton) mButtonsView.findViewById(moreButton);
        ...
        mOutlineButton.setVisibility(View.GONE);
        mAnnotButton.setVisibility(View.GONE);
        mAnnotTypeText.setVisibility(View.GONE);
